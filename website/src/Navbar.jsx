    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex flex-col sm:flex-row items-center justify-between py-4 px-6 border-b border-white/10 bg-background/80 backdrop-blur-md gap-4 sm:gap-0">
            ...
            <div className="hidden md:flex gap-8 font-mono text-sm uppercase tracking-wider items-center">
                <a href={sectionHref("features")} className="text-muted hover:text-white transition-colors">features</a>
                <a href={sectionHref("commands")} className="text-muted hover:text-white transition-colors">commands</a>
                <a href={sectionHref("tui")} className="text-muted hover:text-white transition-colors">tui</a>
            ...
            <div className="flex gap-4 items-center">
                ...
                <a href={sectionHref("install")} className="inline-flex items-center justify-center px-6 py-2 text-sm font-body font-semibold text-white uppercase tracking-wider bg-gradient-primary rounded-full shadow-glow-primary hover:shadow-glow-primary-hover hover:-translate-y-0.5 transition-all">
                    Get Started
                </a>
            </div>
        </nav>
